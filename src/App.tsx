    ...
    <div className="relative min-h-screen bg-[#020617] font-sans text-slate-100 antialiased selection:bg-blue-500 selection:text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <img
          ...
          className="w-full h-full object-cover scale-105 filter blur-3xl opacity-30 transition-all duration-700 absolute inset-0"
        />
        <div className={`absolute inset-0 ${theme === 'dark' ? 'bg-[#020617]/50' : theme === 'light' ? 'bg-slate-900/40' : 'bg-[#020617]/60'} backdrop-blur-3xl`}></div>
      </div>
